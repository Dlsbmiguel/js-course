...
// SLICE METHOD IT DOESNT MUTATES THE ARRAY
...
// REVERSE METHOD IT MUTATES THE ARRAY
arr = ['a', 'b', 'c', 'd', 'e'];
const arr2 = ['j', 'i', 'h', 'g', 'f'];
console.log(arr2.reverse());
console.log(arr2);

// CONCAT METHOD IT DOESNT MUTATES THE ARRAY
...
console.log('------ FOREACH -------');
// CONTINUE AND BREAK DONT WORK ON THIS LOOP
movements.forEach(function (mov, i, arr) {
  //FIRST PARAMETER CURRENT ELEMENT, SECOND CURRENT INDEX, THIRD ENTIRE ARRAY
  if (mov > 0) {
...
const checkDogs = function (dogsJulia, dogsKate) {
  // Creating a copy of original array because of good practice
  const dogsJuliaCopy = dogsJulia.slice(1, -2);
  const allDogs = dogsJuliaCopy.concat(dogsKate);

  // Looping over array to get the respective sentences
...
/////////////////////////////////////////////////////////
// More ways of Creating and Filling Arrays, vid #165
const arr = [1, 2, 3, 4, 5, 6, 7];
console.log(new Array(1, 2, 3, 4, 5, 6, 7));

// Empty arrays + fill method, it mutates the og array
const x = new Array(7);
console.log(x);
...
labelBalance.addEventListener('click', function () {
  ...
  // Same as above but would have to map it separately
