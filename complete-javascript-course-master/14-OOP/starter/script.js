...
class PersonCl {
  ...
  // Instance methods
  // Methods will be added to .prototype porperty
  calcAge() {
    console.log(2037 - this.birthYear);
  }
  ...
  //Static Method #215 pertenece solo al constructor
  static hey() {
...
class Account {
  ...
  constructor(owner, currency, pin) {
    ...
    // Protected property the _ means property is protected, is just a convention so it's still available but other devps will know that they shouldn't mess with it.
    // this._pin = pin;
    this.#pin = pin;
...
//////////////////////////////////////////////////////
// #225 Chaining methods in order to do so you have to return de object by returning the this keyword inside the method
...
rivian.accelerate().brake().accelerate().chargeBattery(90).accelerate().brake();
